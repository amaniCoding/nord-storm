...
export default function SmallBeautyMega(props: { onClose: Dispatch<SetStateAction<boolean>>, isSmallMegaShown: boolean, smallMegaToShow: string | null }) {
  return (
    //react/no-unescaped-entities
      <div className={`block md:hidden h-screen transition duration-200 ease-in-out bg-white fixed z-20 top-0 left-0 overflow-y-scroll socrollabar scroll_content pt-5 pl-5 ${props.isSmallMegaShown && props.smallMegaToShow === 'beauty' ? 'translate-x-0' : '-translate-x-full'}`}>
